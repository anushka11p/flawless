...
export default function App() {
  ...
  function handleNavClick(id, filter) {
  ...
  return (
    <div style={{ fontFamily: 'DM Sans, sans-serif', background: '#faf8f4', minHeight: '100vh' }}>
      ...
      <Navbar cartCount={cartCount} onCartOpen={() => setCartOpen(true)} onNavClick={handleNavClick} />
      ...
      <section id="shop">
        <ProductGrid onAddToCart={addToCart} activeFilter={activeFilter} setActiveFilter={setActiveFilter} />
      </section>
